...
def test_api_pubtator3_api_end_to_end(query, error_message, tempdir):
    ...
    ), f"Expected message '{error_message}', but got '{last_message}'"
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            {
                "query": "foo",
                "savepath": Path("query_foo.pubtator"),
                "type": "query",
                "max_articles": 1000,
                "full_text": False,
                "use_mesh": False,
        ...
        (
            ...
            {
                "query": ["123", "456"],
                "savepath": Path("pmids_123_total_2.pubtator"),
                "type": "pmids",
                "max_articles": 1000,
                "full_text": True,
                "use_mesh": False,
        ...
        (
            ...
            {
                "query": ["34205807", "34895069", "35883435"],
                "savepath": Path("pmids_34205807_total_3.pubtator"),
                "type": "pmids",
                "max_articles": 10000,
                "full_text": False,
                "use_mesh": False,
